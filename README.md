...
*  Subnet ID=subnet-0b9c55b1c69958258 name=bastionSubnet PUBLIC. The code refers to the availability zone, ap-southeast-1b, to identify this subnet for the bastion host.
